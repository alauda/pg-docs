...
| postgresql.version | "16" | PostgreSQL 主版本（11 - 已弃用，12, 14 或 16）。版本 11 将在未来版本中移除。 |
...
| patroni.synchronous_mode | true | 是否启用同步复制 |
| patroni.synchronous_node_count | 2 | 同步复制节点数 |

...
1. Monitoring data is retained for 7 days by default
2. Some metrics require the statistics collector to be enabled
3. It is recommended to set alert thresholds for critical metrics

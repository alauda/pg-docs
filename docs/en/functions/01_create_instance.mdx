...
<Tabs>
  ...
  <Tab label="Web Console">
    ...
    ![PostgreSQL Instance Creation Interface](./assets/create_postgres_ui.png "PostgreSQL Instance Creation Interface")
...
> **Note**
> 
> 1. For production environments, use the [primary-replica architecture](#architecture-choices)

...
- Each minor version remains supported **until the next minor version is officially released**. This is done by releasing patches that apply to each supported minor version.

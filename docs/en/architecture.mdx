...
4. **pgBouncer**
   - Provides connection pooling functionality
...
5. pgBouncer provides connection pooling services
6. The monitoring component collects metrics and displays them
...
- **Read-Write Separation Mode**: Implements read-write separation using pgBouncer

## Related Concepts

- [Custom Resource Definition (CRD)](../concepts/crd.mdx)
- [High Availability Architecture](../concepts/ha.mdx)
- [Connection Pool](../concepts/connection_pool.mdx)
- [Monitoring System](../concepts/monitoring.mdx)

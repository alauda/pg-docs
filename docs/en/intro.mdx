...
- **Version Support**\
  Currently supports PostgreSQL versions 13, 14, 15, 16, and 17 (17 is recommended for new deployments). PostgreSQL 12 and earlier are end-of-life and no longer supported.

...
- **Version Support**\
  Currently supports PostgreSQL versions 13, 14, 15, and 16 (16 is recommended for new deployments). PostgreSQL 12 and earlier are end-of-life and no longer supported.

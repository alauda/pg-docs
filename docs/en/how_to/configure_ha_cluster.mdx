...
- Systems needing automatic failover and recovery
- Workloads requiring read/write separation and load balancing
...
=======
  <tr>
    <td>High Availability Configuration</td>
    <td>
      - Enable synchronous replication
      - Set number of synchronous nodes
